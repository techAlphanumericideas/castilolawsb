          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-8 leading-tight hero-reveal">
                Sexual Abuse & <br />
                <span className="text-[#C5A059] italic">Molestation</span>
              </h1>
              <p className="text-xl text-white/70 font-light leading-relaxed mb-10 hero-reveal max-w-2xl">
                Gentle yet aggressive pursuit of justice. We provide a safe space 
                and powerful legal protection for survivors of abuse and institutional neglect.
              </p>
            </div>
          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="reveal-up">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-10">
                Beyond the abuser, institutions like schools, religious organizations, and workplaces 
                often bear responsibility for failing to prevent harm. We are dedicated to holding 
                these powerful entities accountable and securing the resources survivors need 
                ...
                {[
                  {
                    ...
                    title: "Institutional Negligence",
                    desc: "Holding organizations responsible for negligent hiring, supervision, and failures to act.",
                  },
                  {
                    icon: <Scale className="w-6 h-6" />,
                    title: "Civil Justice Path",
                    desc: "Leveraging the civil court system to achieve the financial restoration and closure the criminal system may lack.",
                  },
                  {
                    icon: <AlertTriangle className="w-6 h-6" />,
                    title: "Confidentiality First",
                    desc: "Strict adherence to privacy and survivor-centered legal strategies to protect your identity.",
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: "Powerful Protection",
                    desc: "Aggressive litigation to ensure survivors are not silenced and their voices are heard.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
...
export default SexualAbusePage;
