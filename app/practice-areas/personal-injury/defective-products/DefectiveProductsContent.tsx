...
import { Package, ShieldAlert, AlertTriangle, ArrowRight, Activity } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              <p className="text-xl text-white/70 font-light leading-relaxed mb-10 hero-reveal max-w-2xl">
                Holding manufacturers accountable for unsafe goods. We fight for 
                consumers injured by defective designs, manufacturing errors, and 
                failure to warn.
              </p>
            </div>
            ...
            <div className="lg:col-span-5 relative w-full h-[280px] md:h-[300px] lg:h-[300px] hero-portrait flex items-start justify-center lg:justify-end">
              <div className="relative w-full max-w-[400px] h-full rounded-[2rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-white/20 bg-white/5 backdrop-blur-sm">
                 ...
                 <Image
                   ...
                   alt="Attorney Osbelia Castillo - Expert in Defective Products and Liability Claims"
                   fill
                ...
                {[
                  {
                    ...
                    desc: "Claims for products that were designed safely but became dangerous during the production process.",
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: "Design Flaws",
                    desc: "Representation for inherently dangerous products that lack necessary safety features.",
                  },
                  {
                    icon: <AlertTriangle className="w-6 h-6" />,
                    title: "Failure to Warn",
                    desc: "Fighting for victims who were not properly alerted to the side effects or risks of a product.",
                  },
                  {
                    icon: <Activity className="w-6 h-6" />,
                    title: "Dangerous Drugs",
                    desc: "Specialized advocacy for those harmed by pharmaceutical products with undisclosed risks.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
            ...
            <div className="reveal-up">
              <div className="bg-[#0A1128] text-white p-10 rounded-[2rem] relative overflow-hidden">
                ...
                <p className="text-white/70 leading-relaxed mb-6 relative z-10">
                   Large corporations have teams of lawyers. You need an aggressive 
                   advocate who isn't afraid to fight for the maximum recovery you deserve.
                </p>
                <a
                  href="tel:8052837656"
                  aria-label="Contact Osbelia Castillo for a defective product consultation"
