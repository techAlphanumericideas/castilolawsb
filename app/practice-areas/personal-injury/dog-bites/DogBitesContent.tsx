          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              <p className="text-xl text-white/70 font-light leading-relaxed mb-10 hero-reveal max-w-2xl">
                Holding owners accountable for animal attacks. We specialize in 
                securing compensation for the physical and emotional trauma 
                caused by dog bites.
              </p>
            </div>
            ...
            <div className="lg:col-span-5 relative w-full h-[280px] md:h-[300px] lg:h-[300px] hero-portrait flex items-start justify-center lg:justify-end">
              <div className="relative w-full max-w-[400px] h-full rounded-[2rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-white/20 bg-white/5 backdrop-blur-sm">
                 ...
                 <Image
                   ...
                   alt="Attorney Osbelia Castillo - Dedicated Dog Bite and Animal Attack Lawyer"
                   fill
                ...
                {[
                  {
                    ...
                    desc: "Advocating for victims who require plastic surgery or long-term wound care.",
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: "Statewide Strict Liability",
                    desc: "Leveraging California's clear laws to hold animal owners fully accountable.",
                  },
                  {
                    icon: <AlertTriangle className="w-6 h-6" />,
                    title: "Emotional Trauma",
                    desc: "Fighting for compensation for the psychological impact and fear often caused by attacks.",
                  },
                  {
                    icon: <Activity className="w-6 h-6" />,
                    title: "Infection & Long-term Care",
                    desc: "Ensuring your settlement covers all medical treatments, including specialized therapy.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
...
export default DogBitesContent;
