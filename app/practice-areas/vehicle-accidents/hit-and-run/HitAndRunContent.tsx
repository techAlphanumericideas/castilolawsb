...
import { Scale, ShieldAlert, AlertTriangle, ArrowRight, Search } from "lucide-react";
import ContactForm from "@/components/ContactForm";

gsap.registerPlugin(ScrollTrigger);

const HitAndRunContent = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-8 leading-tight hero-reveal">
                Hit and Run <br />
                <span className="text-[#C5A059] italic">Claims</span>
              </h1>
              <p className="text-xl text-white/70 font-light leading-relaxed mb-10 hero-reveal max-w-2xl">
                When a driver flees the scene, they leave behind more than just damage. 
                We use every resource to track down responsible parties and secure your recovery.
              </p>
            </div>
            ...
            <div className="lg:col-span-5 relative w-full h-[280px] md:h-[300px] lg:h-[300px] hero-portrait flex items-start justify-center lg:justify-end">
              <div className="relative w-full max-w-[400px] h-full rounded-[2rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-white/20 bg-white/5 backdrop-blur-sm">
                 ...
                 <Image
                   ...
                   alt="Attorney Osbelia Castillo specializing in hit and run accident claims"
                   fill
          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="reveal-up">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-10">
                A hit and run accident can feel overwhelming and hopeless. However, there are 
                multiple avenues for recovery, including uninsured motorist coverage and 
                thorough investigations to locate the fleeing driver.
              </p>
                ...
                {[
                  {
                    ...
                    title: "Investigation",
                    desc: "Working with private investigators and surveillance footage to identify the vehicle and driver.",
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: "UM/UIM Claims",
                    desc: "Maximizing your own insurance policy's uninsured motorist benefits when the driver remains unknown.",
                  },
                  {
                    icon: <AlertTriangle className="w-6 h-6" />,
                    title: "Criminal Charges",
                    desc: "Coordinating with law enforcement to support criminal hit and run prosecutions.",
                  },
                  {
                    icon: <Scale className="w-6 h-6" />,
                    title: "Full Damages",
                    desc: "Seeking compensation for medical bills, pain and suffering, and property damage.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
...
export default HitAndRunContent;
