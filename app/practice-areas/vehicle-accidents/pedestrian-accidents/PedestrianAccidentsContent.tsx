...
import { Scale, ShieldCheck, ArrowRight, UserCheck } from "lucide-react";
import ContactForm from "@/components/ContactForm";

gsap.registerPlugin(ScrollTrigger);

const PedestrianAccidentsContent = () => {
            ...
            <div className="lg:col-span-5 relative w-full h-[280px] md:h-[300px] lg:h-[300px] hero-portrait flex items-start justify-center lg:justify-end">
              <div className="relative w-full max-w-[400px] h-full rounded-[2rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-white/20 bg-white/5 backdrop-blur-sm">
                 ...
                 <Image
                   ...
                   alt="Attorney Osbelia Castillo - Pedestrian Accident Lawyer fighting for walkability and safety"
                   fill
          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="reveal-up">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-10">
                Pedestrians are the most vulnerable group on the road. When a driver fails to yield 
                the right-of-way or drives distracted, the results are often catastrophic. 
                We are here to help you navigate the legal system and recover.
              </p>
                ...
                {[
                  {
                    ...
                    title: "Duty of Care",
                    desc: "Proving that the driver violated their elevated duty of care toward pedestrians.",
                  },
                  {
                    icon: <ShieldCheck className="w-6 h-6" />,
                    title: "Medical Advocacy",
                    desc: "Helping you secure immediate expert care for severe orthopedic and head injuries.",
                  },
                  {
                    icon: <Scale className="w-6 h-6" />,
                    title: "Yield Violations",
                    desc: "Investigating intersection and crosswalk collisions where drivers failed to yield.",
                  },
                  {
                    icon: <ArrowRight className="w-6 h-6" />,
                    title: "Maximum Settlement",
                    desc: "Aggressively pursuing the highest possible recovery for your pain and losses.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
...
export default PedestrianAccidentsContent;
