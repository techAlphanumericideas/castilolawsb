          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="reveal-up">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#0A1128] mb-8">
                {t("wrongfulDeath.future.title")}
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-10">
                {t("wrongfulDeath.future.description")}
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  {
                    icon: <Users />,
                    title: t("wrongfulDeath.future.survival"),
                    desc: t("wrongfulDeath.future.survivalDesc"),
                  },
                  {
                    icon: <Heart />,
                    title: t("wrongfulDeath.future.consortium"),
                    desc: t("wrongfulDeath.future.consortiumDesc"),
                  },
                  {
                    icon: <Banknote />,
                    title: t("wrongfulDeath.future.earnings"),
                    desc: t("wrongfulDeath.future.earningsDesc"),
                  },
                  {
                    icon: <FileText />,
                    title: t("wrongfulDeath.future.funeral"),
                    desc: t("wrongfulDeath.future.funeralDesc"),
                  },
                ].map((item, i) => (
                  <div
                    key={i}
...
export default WrongfulDeathContent;
