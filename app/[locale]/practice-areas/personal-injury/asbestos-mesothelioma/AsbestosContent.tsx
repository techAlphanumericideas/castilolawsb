...
import { ShieldAlert, AlertTriangle, Activity, FileText } from "lucide-react";
import ContactForm from "@/components/ContactForm";
import { useTranslations } from "next-intl";

gsap.registerPlugin(ScrollTrigger);

const AsbestosContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.asbestos");
...
export default AsbestosContent;
