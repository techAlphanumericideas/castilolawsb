...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "PracticeAreasPage.subPages.asbestos.metadata" });
  const baseUrl = "https://castillolawsb.com";
  const path = "/practice-areas/personal-injury/asbestos-mesothelioma";
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const subT = await getTranslations({ locale, namespace: "PracticeAreasPage.subPages.asbestos" });
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `https://castillolawsb.com/${locale}/practice-areas/personal-injury/asbestos-mesothelioma`
      }
    ]
  };
