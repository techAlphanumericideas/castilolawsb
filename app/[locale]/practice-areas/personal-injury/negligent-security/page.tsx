...
import NegligentSecurityContent from "./NegligentSecurity";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const path = "/practice-areas/personal-injury/negligent-security";
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `https://castillolawsb.com/${locale}/practice-areas/personal-injury/negligent-security`
      }
    ]
  };
