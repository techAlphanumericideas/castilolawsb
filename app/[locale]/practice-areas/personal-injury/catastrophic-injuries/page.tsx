...
import CatastrophicInjuryContent from "./CatastrophicInjuries";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const path = "/practice-areas/personal-injury/catastrophic-injuries";
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const subT = await getTranslations({ locale, namespace: "PracticeAreasPage.subPages.catastrophicInjuries" });
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `https://castillolawsb.com/${locale}/practice-areas/personal-injury/catastrophic-injuries`
      }
    ]
  };
