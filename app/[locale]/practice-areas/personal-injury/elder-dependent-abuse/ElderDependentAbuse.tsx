...
import { HeartHandshake, ShieldAlert, Scale, AlertCircle } from "lucide-react";
import ContactForm from "@/components/ContactForm";
import { useTranslations } from "next-intl";

gsap.registerPlugin(ScrollTrigger);

const ElderAbuseContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.elderAbuse");
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-8 space-y-16">
            ...
            {/* Section 2: Signs/Types of Abuse */}
            <div className="reveal-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-8 bg-[#FCFCFC] border border-gray-100 rounded-2xl md:col-span-2">
                  <HeartHandshake className="w-8 h-8 text-[#C5A059] mb-4" />
            ...
            {/* Defense Advantage Banner - Unchanged Template Detail */}
            <div className="reveal-up">
...
export default ElderAbuseContent;