...
import { ShieldCheck, Heart, Scale, Users } from "lucide-react";
import ContactForm from "@/components/ContactForm";
import { useTranslations } from "next-intl";

gsap.registerPlugin(ScrollTrigger);

const SexualAbuseContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.sexualAbuse");
...
export default SexualAbuseContent;
