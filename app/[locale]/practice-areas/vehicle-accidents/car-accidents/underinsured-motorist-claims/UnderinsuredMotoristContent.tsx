...
import { ShieldCheck, UserMinus, Zap, Scale } from "lucide-react";
            ...
            <div className="reveal-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  { icon: <UserMinus className="w-6 h-6" />, title: t("content.section2.items.item3"), desc: t("content.section2.items.item4") },
                  { icon: <Zap className="w-6 h-6" />, title: t("content.section2.items.item5"), desc: t("content.section2.items.item6") },
                  { icon: <Scale className="w-6 h-6" />, title: commonT("maximumRecovery"), desc: t("content.section3.p1") },
                ].map((item, i) => (
...
export default UnderinsuredMotoristContent;