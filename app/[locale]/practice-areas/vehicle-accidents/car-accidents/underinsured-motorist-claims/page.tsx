...
import UnderinsuredMotoristContent from "./UnderinsuredMotoristContent";
import JsonLd from "@/components/JsonLd";
import { getTranslations } from "next-intl/server";

const baseUrl = "https://castillolawsb.com";
const path = "/practice-areas/personal-injury/car-accidents/underinsured-motorist-claims";
