...
import { Wrench, CarFront, Receipt, ShieldCheck } from "lucide-react";
import ContactForm from "@/components/ContactForm";
import { useTranslations } from "next-intl";

gsap.registerPlugin(ScrollTrigger);

const PropertyDamageContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.propertyDamages");
          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="reveal-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { icon: <CarFront className="w-6 h-6" />, title: t("content.section2.items.item1"), desc: t("content.section2.items.item2") },
                  { icon: <Receipt className="w-6 h-6" />, title: t("content.section2.items.item3"), desc: t("content.section2.items.item4") },
                  { icon: <Wrench className="w-6 h-6" />, title: t("content.section2.items.item5"), desc: t("content.section2.items.item6") },
                  { icon: <ShieldCheck className="w-6 h-6" />, title: commonT("maximumRecovery"), desc: t("content.section3.p1") },
                ].map((item, i) => (
...
export default PropertyDamageContent;