...
import { Car, Scale, ShieldCheck, Stethoscope } from "lucide-react";
import ContactForm from "@/components/ContactForm";
import { useTranslations } from "next-intl";

gsap.registerPlugin(ScrollTrigger);

const CarAccidentContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.carAccidents");
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <div className="reveal-up">
              <div className="bg-[#FCFCFC] p-10 rounded-[2rem] border border-[#0A1128]/5 relative overflow-hidden">
                <h3 className="text-[10px] font-sans font-black tracking-widest text-[#C5A059] uppercase mb-4">
                  {commonT("defenseAdvantage")}
                </h3>
                <p className="text-[#0A1128] leading-relaxed italic font-serif text-xl">
                   "{t("content.quote")}"
                </p>
              </div>
            </div>
...
export default CarAccidentContent;