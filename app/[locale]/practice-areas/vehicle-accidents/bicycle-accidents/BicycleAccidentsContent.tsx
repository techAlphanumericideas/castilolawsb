...
import { Bike, ShieldAlert, Scale, LifeBuoy } from "lucide-react";
...
const BicycleAccidentsContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.bicycle");
            ...
            <div className="lg:col-span-5 relative w-full h-[280px] md:h-[300px] lg:h-[300px] hero-portrait flex items-start justify-center lg:justify-end">
              <div className="relative w-full max-w-[400px] h-full rounded-[2rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-white/20 bg-white/5 backdrop-blur-sm">
                 ...
                 <Image
                   ...
                   alt="Attorney Osbelia Castillo - Bicycle Accident Law Specialist"
                   fill
                ...
                {[
                  {
                    ...
                    title: t("content.roadwayAdvocacy"),
                    desc: t("content.roadwayAdvocacyDesc"),
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: t("content.medicalSupport"),
                    desc: t("content.medicalSupportDesc"),
                  },
                  {
                    icon: <LifeBuoy className="w-6 h-6" />,
                    title: t("content.liabilityFocus"),
                    desc: t("content.liabilityFocusDesc"),
                  },
                  {
                    icon: <Scale className="w-6 h-6" />,
                    title: t("content.maximumRecovery"),
                    desc: t("content.maximumRecoveryDesc"),
                  },
                ].map((item, i) => (
                  <div
                    key={i}
