...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "PracticeAreasPage.subPages.hitAndRun" });
  const baseUrl = "https://castillolawsb.com";
  const path = "/practice-areas/vehicle-accidents/hit-and-run";
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const subT = await getTranslations({ locale, namespace: "PracticeAreasPage.subPages.hitAndRun" });
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `https://castillolawsb.com/${locale}/practice-areas/vehicle-accidents/hit-and-run`
      }
    ]
  };
