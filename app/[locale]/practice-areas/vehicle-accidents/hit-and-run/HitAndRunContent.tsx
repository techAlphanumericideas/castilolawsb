...
import { Search, ShieldAlert, Scale, Siren } from "lucide-react";
...
const HitAndRunContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.hitAndRun");
                ...
                {[
                  {
                    ...
                    title: t("content.investigation"),
                    desc: t("content.investigationDesc"),
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: t("content.umClaims"),
                    desc: t("content.umClaimsDesc"),
                  },
                  {
                    icon: <Siren className="w-6 h-6" />,
                    title: t("content.criminalCharges"),
                    desc: t("content.criminalChargesDesc"),
                  },
                  {
                    icon: <Scale className="w-6 h-6" />,
                    title: t("content.fullDamages"),
                    desc: t("content.fullDamagesDesc"),
                  },
                ].map((item, i) => (
                  <div
                    key={i}
