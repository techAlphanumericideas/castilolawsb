...
import { Smartphone, ShieldAlert, Scale, AlertOctagon } from "lucide-react";
...
const CellPhoneUseContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.cellPhone");
                ...
                {[
                  {
                    ...
                    title: t("content.forensics"),
                    desc: t("content.forensicsDesc"),
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: t("content.highImpact"),
                    desc: t("content.highImpactDesc"),
                  },
                  {
                    icon: <AlertOctagon className="w-6 h-6" />,
                    title: t("content.victimRights"),
                    desc: t("content.victimRightsDesc"),
                  },
                  {
                    icon: <Scale className="w-6 h-6" />,
                    title: t("content.handsFree"),
                    desc: t("content.handsFreeDesc"),
                  },
                ].map((item, i) => (
                  <div
                    key={i}
