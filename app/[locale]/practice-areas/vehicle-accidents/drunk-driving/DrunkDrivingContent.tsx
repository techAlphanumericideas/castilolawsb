...
import { Beer, ShieldAlert, Scale, Gavel } from "lucide-react";
...
const DrunkDrivingContent = () => {
  const t = useTranslations("PracticeAreasPage.subPages.drunkDriving");
                ...
                {[
                  {
                    ...
                    title: t("content.punitive"),
                    desc: t("content.punitiveDesc"),
                  },
                  {
                    icon: <ShieldAlert className="w-6 h-6" />,
                    title: t("content.proof"),
                    desc: t("content.proofDesc"),
                  },
                  {
                    icon: <Gavel className="w-6 h-6" />,
                    title: t("content.fullLiability"),
                    desc: t("content.fullLiabilityDesc"),
                  },
                  {
                    icon: <Scale className="w-6 h-6" />,
                    title: t("content.criminalCivil"),
                    desc: t("content.criminalCivilDesc"),
                  },
                ].map((item, i) => (
                  <div
                    key={i}
